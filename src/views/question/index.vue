  ...
  <div class="question-container">
    <el-form ref="form" :model="questionData" :rules="ruleForm" label-width="110px">
      ...
      <el-form-item label="内容：" prop="question">
        <el-input type="textarea" v-model="questionData.question" />
      </el-form-item>
      <el-form-item label="农作物名称：" prop="plantName">
        <el-input type="textarea" v-model="questionData.plantName" />
      </el-form-item>
      <el-form-item label="手机号：" prop="phone">
        <el-input type="text" v-model="questionData.phone" />
      </el-form-item>
...
const onSubmit = () => {
  ...
  createQuestionDataApi(questionData.value)
    .then((res) => {
