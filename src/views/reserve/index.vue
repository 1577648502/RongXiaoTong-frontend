  ...
  <div class="appointment-container">
    <el-form :model="reserveData" :rules="rules" ref="ruleForm" label-width="110px" class="demo-ruleForm">
      <el-form-item label="地址" prop="address">
        <el-input v-model="reserveData.address" placeholder="请输入地址" />
      </el-form-item>
      <el-form-item label="种植作物" prop="plantName">
        <el-input v-model="reserveData.plantName" placeholder="请输入种植的作物" />
      </el-form-item>
      <el-form-item label="作物详细信息" prop="plantDetail">
        <el-input v-model="reserveData.plantDetail" placeholder="请输入作物详细信息" />
      </el-form-item>
      <el-form-item label="作物条件" prop="plantCondition">
        <el-input v-model="reserveData.plantCondition" placeholder="请输入作物生长状况" />
      </el-form-item>
      <el-form-item label="土壤条件" prop="soilCondition">
        <el-input v-model="reserveData.soilCondition" placeholder="请输入土壤状况" />
      </el-form-item>
      <el-form-item label="面积" prop="area">
        <el-input v-model="reserveData.area" placeholder="请输入面积" />
      </el-form-item>
      <el-form-item label="电话" prop="phone">
        <el-input v-model="reserveData.phone" placeholder="请输入电话" />
      </el-form-item>
